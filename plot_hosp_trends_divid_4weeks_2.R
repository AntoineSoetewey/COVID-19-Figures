...
dat <- dat %>%
  mutate(population = case_when(
    PROVINCE == levels(PROVINCE)[1] ~ 1857986,
    PROVINCE == levels(PROVINCE)[2] ~ 403599,
    PROVINCE == levels(PROVINCE)[3] ~ 1208542,
    PROVINCE == levels(PROVINCE)[4] ~ 1344241,
    PROVINCE == levels(PROVINCE)[5] ~ 1106992,
    PROVINCE == levels(PROVINCE)[6] ~ 874048,
    PROVINCE == levels(PROVINCE)[7] ~ 284638,
    PROVINCE == levels(PROVINCE)[8] ~ 494325,
    PROVINCE == levels(PROVINCE)[9] ~ 1515064,
    PROVINCE == levels(PROVINCE)[10] ~ 1146175,
    PROVINCE == levels(PROVINCE)[11] ~ 1195796,
    PROVINCE == levels(PROVINCE)[12] ~ 11431406
  )) %>%
...
period1<- paste0("Période / periode : ", format(max(dat$DATE)-30, format = "%d/%m")," - ",
                 format(max(dat$DATE), format = "%d/%m"),"   ")
period2<- paste0("Période / periode : ", format(max(dat$DATE)-6, format = "%d/%m"), " - ",
                 format(max(dat$DATE), format = "%d/%m"),"   ")
