...
=======
dat <- read.csv("https://epistat.sciensano.be/Data/COVID19BE_HOSP.csv", fileEncoding = "UTF-8", stringsAsFactors = FALSE)
>>>>>>> 7f59714691caf6f5f8d8b60a7781fe868df1b558
...
=======
  ...
  labs(fill = bquote(atop(NA, atop("Hospital admissions (x100,000 inh.)", bold(.(period1)))))) +
  theme_void() +
  theme(
    # Change legend
...
=======
  ...
  labs(fill = bquote(atop(NA, atop("Hospital admissions (x100,000 inh.)", bold(.(period2)))))) +
>>>>>>> 7f59714691caf6f5f8d8b60a7781fe868df1b558
  theme_void() +
  theme(
    # Change legend
...
# save plot
png(file = "Belgian_Hospitalisations_2409_5col.png", width = 15 * 360, heigh = 7 * 360, units = "px", pointsize = 7, res = 300)
ggarrange(ggarrange(map1, map2, ncol = 1),
  grid.arrange(fig_trends, bottom = caption),
  ncol = 2, widths = c(1, 1.5)
>>>>>>> 7f59714691caf6f5f8d8b60a7781fe868df1b558
