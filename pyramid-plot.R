...
p1 <- ggplot(data=dat) +
  ...
  geom_bar(aes(AGEGROUP,-CASES,group=SEX,fill=SEX),
           stat = "identity",
           subset(dat,SEX=="Male")) +
  scale_y_continuous(breaks=seq(-round_any(max(dat$CASES), 1000, f = ceiling), round_any(max(dat$CASES), 1000, f = ceiling), 2000),
...
p2 <- ggplot(data=dat) +
  ...
  geom_bar(aes(AGEGROUP,-CASES,group=SEX,fill=SEX),
           stat = "identity",
           subset(dat,SEX=="Male")) +
  scale_y_continuous(breaks=seq(-round_any(max(dat$CASES), 1000, f = ceiling), round_any(max(dat$CASES), 1000, f = ceiling), 1000),
...
p3 <- ggplot(data=dat) +
  ...
  geom_bar(aes(AGEGROUP,-CASES,group=SEX,fill=SEX),
           stat = "identity",
           subset(dat,SEX=="Male")) +
  scale_y_continuous(breaks=seq(-round_any(max(dat$CASES), 100, f = ceiling), round_any(max(dat$CASES), 100, f = ceiling), 100),
